      ...
      <label className="flex items-center gap-1.5 text-[10px] font-medium text-portal-muted mb-1">
        ...
        {tooltip && (
          <span className="group relative">
            ...
            <span className="absolute left-0 bottom-full mb-1 hidden group-hover:block w-48 p-2 text-[10px] text-portal-text bg-portal-card border border-portal-border rounded-lg shadow-lg z-[9999] whitespace-normal">
              {tooltip}
            </span>
          </span>
        )}
